...
public class FacultyView {
    ...
    private Label totalFacultiesValue;
    private Label databaseStatusValue;
    private Label selectedFacultyValue;
    ...
    public FacultyView(Stage stage) {
        this.stage = stage;
    }
    ...
    public void show() {
        ...
        stage.setTitle(
                "Faculty Management - Faculty Management System"
        );
    ...
    private HBox createHeader() {
        ...
        Label subtitleLabel =
                new Label(
                        "Manage all university faculty records"
                );
    ...
    private HBox createFormSection() {
        ...
        Label facultyNameLabel =
                new Label(
                        "Faculty Name"
                );

        facultyNameLabel.setStyle(
                "-fx-text-fill:#333333;" +
                        "-fx-font-size:13px;" +
                        "-fx-font-weight:bold;"
        );
        ...
        facultyNameField.setPromptText(
                "Example: Faculty of Computing and Technology"
        );

        facultyNameField.setPrefHeight(43);

        facultyNameField.setStyle(
        ...
        descriptionArea.setPromptText(
                "Enter a short description about the faculty"
        );
    ...
    private VBox createInformationCard() {
        ...
        Label information =
                new Label(
                        "• Faculty names must be unique.\n\n" +
                                "• Faculty names cannot be empty.\n\n" +
                                "• Select a table row before updating\n" +
                                "  or deleting a faculty.\n\n" +
                                "• Departments may depend on faculty\n" +
                                "  records."
                );
    ...
    private VBox createTableSection() {
        ...
        Label tableSubtitle =
                new Label(
                        "Search, select, update or delete faculty records"
                );
        ...
        searchField.setPromptText(
                "Search by faculty ID, name or description"
        );
        ...
        facultyTable.setPrefHeight(350);

        facultyTable.setColumnResizePolicy(
                TableView.CONSTRAINED_RESIZE_POLICY_FLEX_LAST_COLUMN
        );

        facultyTable.setPlaceholder(
                new Label(
        ...
        TableColumn<Faculty, String> descriptionColumn =
                new TableColumn<>(
                        "Description"
                );
        ...
        descriptionColumn.setMinWidth(380);
    ...
    private void stylePrimaryButton(
        ...
        String hoverStyle =
                "-fx-background-color:" + DARK_MAROON + ";" +
                        "-fx-text-fill:white;" +
                        "-fx-background-radius:7;" +
                        "-fx-font-size:12px;" +
                        "-fx-font-weight:bold;" +
    ...
    public TextField getFacultyNameField() {
    ...
    public TableView<Faculty> getFacultyTable() {
        return facultyTable;
    }

    public Label getTotalFacultiesValue() {
        return totalFacultiesValue;
    }
    ...
    public Label getSelectedFacultyValue() {
        return selectedFacultyValue;
    }
