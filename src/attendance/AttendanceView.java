...
public class AttendanceView {
    ...
    private Label totalAttendanceValue;
    private Label databaseStatusValue;
    private Label selectedAttendanceValue;
    ...
    public AttendanceView(Stage stage) {
    ...
    public void show() {
        ...
        stage.setTitle(
                "Attendance Management - Faculty Management System"
        );
    ...
    private HBox createHeader() {
        ...
        Label subtitleLabel =
                new Label(
                        "Record and manage student attendance for courses"
                );
    ...
    private HBox createFormSection() {
        ...
        Label formSubtitle =
                new Label(
                        "Select a student, course, date and attendance status"
                );
        ...
        Label information =
                new Label(
                        "• Select an existing student and course.\n\n" +
                                "• Choose the attendance date using the calendar.\n\n" +
                                "• Attendance status must be PRESENT,\n" +
                                "  ABSENT or LATE.\n\n" +
                                "• A student cannot have duplicate attendance\n" +
                                "  for the same course and date.\n\n" +
                                "• Select a table row before updating or deleting."
                );
    ...
    private VBox createTableSection() {
        ...
        Label tableSubtitle =
                new Label(
                        "Search, update and manage attendance records"
                );
        ...
        attendanceTable.setPrefHeight(430);
        ...
        idColumn.setCellValueFactory(
                new PropertyValueFactory<>("attendanceId")
        );

        TableColumn<Attendance,String> studentColumn =
        ...
        TableColumn<Attendance,String> courseColumn =
        ...
        TableColumn<Attendance,java.time.LocalDate> dateColumn =
    ...
    public TableView<Attendance> getAttendanceTable() {
        return attendanceTable;
    }

    public Label getTotalAttendanceValue() {
        return totalAttendanceValue;
    }
    ...
    public Label getSelectedAttendanceValue() {
        return selectedAttendanceValue;
    }
